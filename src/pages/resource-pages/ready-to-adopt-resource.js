...
const ReadyToAdoptResourcePage = () => (
  <Layout>
    ...
    <p>
    <b>Can you make the necessary time commitment to your new pet?</b>
    </p>
    ...
    <p>
    <b>Can you make the financial commitment to properly care for your new pet?</b>
    </p>
    ...
    <ul>
    <li>Litter, scoop and litter box(es)</li>
    <li>High quality cat food as well as food and water dishes</li>
    <li>Grooming supplies – brush, claw clippers, etc.</li>
    <li>Scratching posts of varying textures and design</li>
    <li>Cat carrier</li>
    </ul>
    ...
    <p>
    <b>Is your house adequately prepared?</b>
    </p>

    <p>
    While cats do not require a lot of space – they are often touted as the ideal pets for apartment living – you will need to make some changes before bringing kitty home. Make sure potentially dangerous items are put safely away, out of your cat's reach – rubber bands, string, moth balls, curtain cords, poisons and shopping bags with handles. Also, be sure to make yourself aware of which household plants may be poisonous to your cat. 
    </p>
